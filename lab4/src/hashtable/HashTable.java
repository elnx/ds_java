...
public class HashTable {
    ...
    public HashTableElement search(Object key) {
        // YOU MADE ME INSTALL AN IDE IN A DATA STRUCTURE COURSE
    	int hash = this.hash(key);
    	LinkedList<HashTableElement> chain = this.chains.get(hash);
    	for (HashTableElement e: chain) {
    		if (e.getKey() == key)
    			return e;
    	}
    	return null;
